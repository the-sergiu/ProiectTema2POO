...
int main() 
{
  ...
  string str = "test";
  vector<Produs*> vec;
  //ProdusAlimentar(const string &categorie,  int id, const string& nume, float leiPerKg, const string& taraOrigine, int cantitate) : Produs(categorie, id, nume, cantitate)
